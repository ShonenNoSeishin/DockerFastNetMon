...
<div class="container">
    ...
    @if (is_array($dc->license()) && isset($dc->license()['licensed_bandwidth']) && isset($dc->license()['expiration_date_carbon']))
        @if ($dc->license()['licensed_bandwidth'] === 0 || strtotime($dc->license()['expiration_date_carbon']) < time())
...
@if (is_array($dc->totalTraffic()))
    <div class="huge">{{ round($dc->totalTraffic()['in_mbps']) }} {{ $dc->totalTraffic()['in_mbps_suffix'] }}</div>
@else
    <div class="huge">Données de trafic non disponibles</div>
@endif
...
@else                                                                                                                                                                                                              
    <div class="huge">Donn..es de trafic non disponibles</div>                                                                                                                                                     
@endif 
